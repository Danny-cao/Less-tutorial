...
<html>
    ...
    <body>
        ...
        <form method="post" action="./lessphp_example_compileFile_tocss.php">
          <table>
          Kleur 1: <input type="color" name="color1" ><br>
          Kleur 2: <input type="color" name="color2" ><br>
          <input type="submit" value="Nieuwe kleur" name="submit">
        </table>
        </form>
